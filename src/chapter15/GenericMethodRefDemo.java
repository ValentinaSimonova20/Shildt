...
// обобщенный метод, объявленный в необобщенном
// классе

// Функциональный интерфейс для обработки
// массива значений и возврата целочисленного
// результата
interface MyFunc3<T> {
    int func(T[] vals, T v);
}

// В этом классе определяется метод
// countMatching(),
// возвращающий количество элементов в
// массиве, равных указанному значению.
// Обратите внимание на то, что метод countMatching()
// является обобщенным,
...
public class GenericMethodRefDemo {
    ...
    public static void main(String[] args) {
        Integer[] vals = {1, 2, 3, 4, 2, 4, 4, 4, 5};
